...
Feature: To verify the different functionalities present on the Disappearing Elements page of Herokuapp website
  ...
  Scenario Outline: To verify that Disappearing Elements option is enabled and clickable
  ...
  Scenario Outline: To verify that user is successfully able to validate the Disappearing Elements page title
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Disappearing Elements" Disappearing Elements link
  ...
  Scenario Outline: To verify that user is successfully able to validate the Disappearing Elements page content
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Disappearing Elements" Disappearing Elements link
  ...
  Scenario Outline: To verify that user is successfully able to validate the About page Link content of Disappearing Elements functionality
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Disappearing Elements" Disappearing Elements link
  ...
  Scenario Outline: To verify that user is successfully able to validate the Contact Us page Link content of Disappearing Elements functionality
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Disappearing Elements" Disappearing Elements link
  ...
  Scenario Outline: To verify that user is successfully able to validate the Portfolio page Link content of Disappearing Elements functionality
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Disappearing Elements" Disappearing Elements link
  ...
  Scenario Outline: To verify that user is successfully able to validate the Home page Link content of Disappearing Elements functionality
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Disappearing Elements" Disappearing Elements link
  ...
  Scenario Outline: To validate whether there any broken links on the Disappearing Elements page
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Disappearing Elements" Disappearing Elements link
