...
Feature: To verify the different functionalities present on the Drag And Drop page of Herokuapp website
  ...
  Scenario: To verify that DragAndDrop option is enabled and clickable
  ...
  Scenario: To verify that user is successfully able to validate the Drag And Drop page title
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Drag And Drop" Drag And Drop link
  ...
  Scenario: To verify that user is successfully able to drag A box from source to B box target on the Drag And Drop page content
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Drag And Drop" Drag And Drop link
  ...
  Scenario: To verify that user is successfully able to drag B box from source to A box target on the Drag And Drop page content
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Drag And Drop" Drag And Drop link
