...
Feature: To verify the different functionalities present on the JQuery UI Menus page of Herokuapp website
  ...
  Scenario: To verify that JQuery UI Menus option is enabled and clickable
  ...
  Scenario: To verify that user is successfully able to validate the JQuery UI Menus page title
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "JQuery UI Menus" JQuery UI Menus link
  ...
  Scenario: To verify that user is successfully able to validate the JQuery UI Menus page content
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "JQuery UI Menus" JQuery UI Menus link
  ...
  Scenario: To verify that user is successfully able to validate the JQuery UI page title
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "JQuery UI Menus" JQuery UI Menus link
  ...
  Scenario: To verify that user is successfully able to validate the JQuery UI page content
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "JQuery UI Menus" JQuery UI Menus link
  ...
  Scenario: To verify that user is successfully able to redirect to the JQuery UI page and back to JQueryUI - Menu page
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "JQuery UI Menus" JQuery UI Menus link
