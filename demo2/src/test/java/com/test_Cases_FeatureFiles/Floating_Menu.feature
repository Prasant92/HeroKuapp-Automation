...
Feature: To verify the different functionalities present on the Floating Menu page of Herokuapp website
  ...
  Scenario: To verify that Floating Menu option is enabled and clickable
  ...
  Scenario: To verify that user is successfully able to validate the Floating Menu page title
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Floating Menu" Floating Menu link
  ...
  Scenario: To verify that user is successfully able to scroll down to bottom of Floating Menu page
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Floating Menu" Floating Menu link
  ...
  Scenario: To verify that user is successfully able to scroll up to top from bottom of Floating Menu page
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Floating Menu" Floating Menu link
  ...
  Scenario: To verify that user is successfully able to click and validate the Home menu on Floating Menu page
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Floating Menu" Floating Menu link
  ...
  Scenario: To verify that user is successfully able to click and validate the News menu on Floating Menu page
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Floating Menu" Floating Menu link
  ...
  Scenario: To verify that user is successfully able to click and validate the Contact menu on Floating Menu page
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Floating Menu" Floating Menu link
  ...
  Scenario: To verify that user is successfully able to click and validate the About menu on Floating Menu page
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Floating Menu" Floating Menu link
