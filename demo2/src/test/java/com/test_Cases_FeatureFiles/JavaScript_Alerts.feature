...
Feature: To verify the different functionalities present on the JavaScript Alerts page of Herokuapp website
  ...
  Scenario: To verify that user is successfully able to validate the JavaScript Alerts page title
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "JavaScript onload event error" JavaScript Alerts link
  ...
  Scenario: To verify that user is successfully able to validate the JavaScript Alerts page content
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "JavaScript onload event error" JavaScript Alerts link
  ...
  Scenario: To verify that user is successfully able to accept the JS alert on the JavaScript Alerts page content
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
  ...
  Scenario: To verify that user is successfully able to accept the JS confirm alert on the JavaScript Alerts page content
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "JavaScript Alerts" JavaScript Alerts link
  ...
  Scenario: To verify that user is successfully able to dismiss the JS confirm alert on the JavaScript Alerts page content
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "JavaScript Alerts" JavaScript Alerts link
  ...
  Scenario: To verify that user is successfully able to accept the JS prompt alert on the JavaScript Alerts page content
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "JavaScript Alerts" JavaScript Alerts link
