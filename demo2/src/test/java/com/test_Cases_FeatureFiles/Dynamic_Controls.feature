...
Feature: To verify the different functionalities present on the Dynamic Controls page of Herokuapp website
  ...
  Scenario: To verify that Dynamic Controls option is enabled and clickable
  ...
  Scenario: To verify that user is successfully able to validate the Dynamic Controls page title
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Dynamic Controls" Dynamic Controls link
  ...
  Scenario: To verify that user is successfully able to click on Remove button without ticking the checkbox on Dynamic Controls page
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Dynamic Controls" Dynamic Controls link
  ...
  Scenario: To verify that user is successfully able to click on Remove button after ticking the checkbox on Dynamic Controls page
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Dynamic Controls" Dynamic Controls link
  ...
  Scenario: To verify that user is successfully able to click on Add button when checkbox is removed without ticking on Dynamic Controls page
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Dynamic Controls" Dynamic Controls link
  ...
  Scenario: To verify that user is successfully able to click on Remove button after ticking the checkbox on Dynamic Controls page
    ...
    Scenario: To verify that user is able to click on Enable button and populate the text into TextBox on Dynamic Controls page
      Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
      When User is on the homePage of the website
      Then Validate that heading of the homepage is "Welcome to the-internet"
      And User clicks on the "Dynamic Controls" Dynamic Controls link
  ...
  Scenario: To verify that user is able to click on Disable button on Dynamic Controls page
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Dynamic Controls" Dynamic Controls link
