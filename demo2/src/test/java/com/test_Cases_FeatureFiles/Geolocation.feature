...
Feature: To verify the different functionalities present on the Geolocation page of Herokuapp website
  ...
  Scenario: To verify that user is successfully able to validate the Geolocation page title
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Geolocation" Geolocation link
  ...
  Scenario: To verify that user is successfully able to validate the Geolocation page content
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Geolocation" Geolocation link
