...
Feature: To verify the different functionalities present on the Notification Messages page of Herokuapp website
  ...
  Scenario: To verify that Notification Messages option is enabled and clickable
  ...
  Scenario: To verify that user is successfully able to validate the Notification Messages page title
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Notification Messages" Notification Messages link
    Then User validates the Page title as "Notification Messages" on Notification Messages link
    And Close the browser session

  Scenario: To verify that user is successfully able to validate the Notification Messages page content
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Notification Messages" Notification Messages link
  ...
  Scenario: To verify that user is successfully able to validate the Action successful on Notification Messages page
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Notification Messages" Notification Messages link
  ...
  Scenario: To verify that user is successfully able to validate the Action unsuccessful, please try again on Notification Messages page
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Notification Messages" Notification Messages link
