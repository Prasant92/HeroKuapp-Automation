...
Feature: To verify the different functionalities present on the Multiple Windows page of Herokuapp website
  ...
  Scenario Outline: To verify that Multiple Windows option is enabled and clickable
  ...
  Scenario Outline: To verify that user is successfully able to validate the Multiple Windows page title
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Multiple Windows" Multiple Windows link
  ...
  Scenario Outline: To verify that user is successfully able to open a new tab and validate the title of the page
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Multiple Windows" Multiple Windows link
