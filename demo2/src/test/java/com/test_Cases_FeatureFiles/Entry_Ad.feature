...
Feature: To verify the different functionalities present on the Entry Ad page of Herokuapp website
  ...
  Scenario Outline: To verify that Entry Ad option is enabled and clickable
  ...
  Scenario Outline: To verify that user is successfully able to validate the Entry Ad page title
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Entry Ad" Entry Ad link
  ...
  Scenario Outline: To verify that user is successfully able to validate the Entry Ad page content
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Entry Ad" Entry Ad link
  ...
  Scenario Outline: To verify that user is successfully able to validate the Modal Window title on Entry Ad page
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Entry Ad" Entry Ad link
  ...
  Scenario Outline: To verify that user is successfully able to validate the Modal Window content on Entry Ad page
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Entry Ad" Entry Ad link
  ...
  Scenario Outline: To verify that user is not able to launch the modal window after clicking on the click here link on Entry Ad page
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Entry Ad" Entry Ad link
