...
Feature: To verify the different functionalities present on the File Upload page of Herokuapp website
  ...
  Scenario: To verify that File Upload option is enabled and clickable
  ...
  Scenario: To verify that user is successfully able to validate the File Upload page title
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "File Upload" File Upload link
  ...
  Scenario: To verify that user is successfully able to validate the File Upload page content
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "File Upload" File Upload link
  ...
  Scenario: To verify that user is successfully able to upload the required files on File Upload page
    Given Start "Firefox" browser and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "File Upload" File Upload link
