...
Feature: To verify the different functionalities present on the Dynamic Loading page of Herokuapp website
  ...
  Scenario Outline: To verify that Dynamic Loading option is enabled and clickable
  ...
  Scenario Outline: To verify that user is successfully able to validate the Dynamic Loading page title
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Dynamic Loading" Dynamic Loading link
  ...
  Scenario Outline: To verify that user is successfully able to validate the Dynamic Loading page content
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Dynamic Loading" Dynamic Loading link
  ...
  Scenario Outline: To validate whether there any broken links on the Dynamic Loading page
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Dynamic Loading" Dynamic Loading link
  ...
  Scenario Outline: To verify that Example 1: Element on page that is hidden option is enabled and clickable
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Dynamic Loading" Dynamic Loading link
  ...
  Scenario Outline: To verify that user is successfully able to validate the Example 1 page title of Dynamic Loading page
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Dynamic Loading" Dynamic Loading link
  ...
  Scenario Outline: To verify that user is successfully able to validate the Example 1 page content of Dynamic Loading page
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Dynamic Loading" Dynamic Loading link
  ...
  Scenario Outline: To verify that user is successfully able to click Start button and validate the text on Example 1 of Dynamic Controls page content
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Dynamic Loading" Dynamic Loading link
  ...
  Scenario Outline: To verify that Example 2: Element rendered after the fact option is enabled and clickable
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Dynamic Loading" Dynamic Loading link
  ...
  Scenario Outline: To verify that user is successfully able to validate the Example 2 page title of Dynamic Loading page
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Dynamic Loading" Dynamic Loading link
  ...
  Scenario Outline: To verify that user is successfully able to validate Example 2 page content of Dynamic Loading page
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Dynamic Loading" Dynamic Loading link
  ...
  Scenario Outline: To verify that user is successfully able to click Start button and validate the text on Example 2 of Dynamic Controls page content
    Given Start "<browser>" and launch the website "https://the-internet.herokuapp.com/"
    When User is on the homePage of the website
    Then Validate that heading of the homepage is "Welcome to the-internet"
    And User clicks on the "Dynamic Loading" Dynamic Loading link
